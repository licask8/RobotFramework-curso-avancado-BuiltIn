...
*** Test Cases ***
### TIMEOUT
Exemplo 01: Teste lidando com timeout do teste
...
Teardown do meu teste
    Run Keyword If Timeout Occurred    Log    Esse teste demorou demais, possivel problema de performace!
